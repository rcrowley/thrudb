...
service Thrudoc
{
    list<string> getTablenames ()                                      throws(ThrudocException e),

    void         put(1:string tablename, 2:string key, 3:string value) throws(ThrudocException e),
    string       get(1:string tablename, 2:string key)                 throws(ThrudocException e),
    void         remove(1:string tablename, 2:string key)              throws(ThrudocException e),

    # if you want thrudoc to generate a doc id for you
    string       putValue(1:string tablename, 2:string value)          throws(ThrudocException e),
    ...
    # includes 0 elements
    ScanResponse scan(1:string tablename, 2:string seed, 3:i32 count)  throws(ThrudocException e),
